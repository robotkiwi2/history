...
const KEYWORD_META = {
  ...
  '고려 인종':         { type: '왕',    era: '고려시대', startYear: 1122,  endYear: 1146  },
  '이자겸의 난':       { type: '운동',  era: '고려시대', startYear: 1126,  endYear: 1127  },
  '묘청의 난':         { type: '운동',  era: '고려시대', startYear: 1135,  endYear: 1136  },
  ...
  // ===== 65회 심화 추가 키워드 =====
  // 삼국
  '고구려 유리왕':     { type: '왕',    era: '삼국시대', startYear: -19,   endYear: 18    },
  '고구려 고국원왕':   { type: '왕',    era: '삼국시대', startYear: 331,   endYear: 371   },
  '강수':              { type: '인물',  era: '삼국시대', startYear: 620,   endYear: 692   },
  '나당동맹':          { type: '사건',  era: '삼국시대', startYear: 648,   endYear: 648   },
  // 남북국
  '고구려 부흥운동':   { type: '운동',  era: '신라시대', startYear: 670,   endYear: 674   },
  // 고려
  '강동 6주':          { type: '사건',  era: '고려시대', startYear: 993,   endYear: 994   },
  '동북 9성':          { type: '사건',  era: '고려시대', startYear: 1107,  endYear: 1109  },
  '계해약조':          { type: '조약',  era: '조선시대', startYear: 1443,  endYear: 1443  },
  // 조선
  '인조반정':          { type: '사건',  era: '조선시대', startYear: 1623,  endYear: 1623  },
  '기사환국':          { type: '사건',  era: '조선시대', startYear: 1689,  endYear: 1689  },
  '이인좌의 난':       { type: '운동',  era: '조선시대', startYear: 1728,  endYear: 1728  },
  '유득공':            { type: '인물',  era: '조선시대', startYear: 1748,  endYear: 1807  },
  // 근대·일제
  '동양 척식 주식회사':{ type: '기관',  era: '근대',     startYear: 1908,  endYear: 1945  },
  '신흥무관학교':      { type: '기관',  era: '근대',     startYear: 1911,  endYear: 1920  },
  '최현배':            { type: '인물',  era: '근대',     startYear: 1894,  endYear: 1970  },
  '5·16 군사정변':     { type: '사건',  era: '근대',     startYear: 1961,  endYear: 1961  },
  '조선 여자 교육회':  { type: '기관',  era: '근대',     startYear: 1920,  endYear: 1926  },
  '자유시 참변':       { type: '사건',  era: '근대',     startYear: 1921,  endYear: 1921  },
  '각간 위홍':         { type: '인물',  era: '신라시대', startYear: 835,   endYear: 888   },
  '대마도 정벌':       { type: '사건',  era: '조선시대', startYear: 1419,  endYear: 1419  },
  // 64회 심화 신규
  '조선 중종':         { type: '왕',    era: '조선시대', startYear: 1506,  endYear: 1544  },
  '창덕궁':            { type: '유물',  era: '조선시대', startYear: 1405,  endYear: 1405  },
  ...
  '혜공왕':            { type: '왕',    era: '신라시대', startYear: 765,   endYear: 780   },
  '신라 원성왕':       { type: '왕',    era: '신라시대', startYear: 785,   endYear: 798   },
  '귀주대첩':          { type: '사건',  era: '고려시대', startYear: 1019,  endYear: 1019  },
  '처인성 전투':       { type: '사건',  era: '고려시대', startYear: 1232,  endYear: 1232  },
  '배중손':            { type: '인물',  era: '고려시대', startYear: 1200,  endYear: 1271  },
  '전민변정도감':      { type: '기관',  era: '고려시대', startYear: 1366,  endYear: 1366  },
  '쌍성총관부':        { type: '기관',  era: '고려시대', startYear: 1258,  endYear: 1356  },
  '갑인자':            { type: '유물',  era: '조선시대', startYear: 1434,  endYear: 1434  },
  '무예도보통지':      { type: '유물',  era: '조선시대', startYear: 1790,  endYear: 1790  },
  '경국대전':          { type: '유물',  era: '조선시대', startYear: 1485,  endYear: 1485  },
  '현량과':            { type: '제도',  era: '조선시대', startYear: 1519,  endYear: 1519  },
  '경복궁':            { type: '유물',  era: '조선시대', startYear: 1395,  endYear: 1395  },
  '경희궁':            { type: '유물',  era: '조선시대', startYear: 1617,  endYear: 1617  },
  '경운궁':            { type: '유물',  era: '조선시대', startYear: 1897,  endYear: 1897  },
  '수시력':            { type: '제도',  era: '고려시대', startYear: 1309,  endYear: 1309  },
  '신숙주':            { type: '인물',  era: '조선시대', startYear: 1417,  endYear: 1475  },
  '오페르트 도굴 사건':{ type: '사건',  era: '조선시대', startYear: 1868,  endYear: 1868  },
  '오산학교':          { type: '기관',  era: '근대',     startYear: 1907,  endYear: 1907  },
  '가쓰라-태프트 밀약':{ type: '사건',  era: '근대',     startYear: 1905,  endYear: 1905  },
  '한일의정서':        { type: '사건',  era: '근대',     startYear: 1904,  endYear: 1904  },
  '황사영 백서':       { type: '사건',  era: '조선시대', startYear: 1801,  endYear: 1801  },
  '교조 신원 운동':    { type: '운동',  era: '조선시대', startYear: 1892,  endYear: 1893  },
  '조선 노동 공제회':  { type: '기관',  era: '근대',     startYear: 1920,  endYear: 1924  },
  '암태도 소작 쟁의':  { type: '사건',  era: '근대',     startYear: 1923,  endYear: 1924  },
  '부민관 폭파 사건':  { type: '사건',  era: '근대',     startYear: 1945,  endYear: 1945  },
  '천도교소년회':      { type: '기관',  era: '근대',     startYear: 1921,  endYear: 1921  },
  '황국중앙총상회':    { type: '기관',  era: '조선시대', startYear: 1898,  endYear: 1899  },
  '한미상호방위조약':  { type: '사건',  era: '근대',     startYear: 1953,  endYear: 1953  },
  '경부고속도로':      { type: '사건',  era: '근대',     startYear: 1970,  endYear: 1970  },
  '제2공화국':         { type: '사건',  era: '근대',     startYear: 1960,  endYear: 1961  },
  '진보당 사건':       { type: '사건',  era: '근대',     startYear: 1958,  endYear: 1958  },
  '개성공단':          { type: '사건',  era: '근대',     startYear: 2000,  endYear: 2003  },
  '안동':              { type: '지역',  era: '조선시대', startYear: 918,   endYear: 1910  },
  '홍산 전투':         { type: '사건',  era: '고려시대', startYear: 1376,  endYear: 1376  },
  '사르후 전투':       { type: '사건',  era: '조선시대', startYear: 1619,  endYear: 1619  },
...
const KEYWORD_ALIAS_TO_BASE = {
  ...
  '나선 정벌': '나선정벌',
  '고려 (경제)': '고려',
  '고려 우왕 (요동 정벌 직전)': '고려 우왕',
  '고려 대몽항쟁': '몽골 침입',
  '광해군 (사르후 전투)': '광해군',
  '이익 (성호사설)': '이익',
  '흥선대원군 집권 초기': '흥선대원군',
  '조미 수호 통상 조약': '조미수호통상조약',
  '아관파천 이후': '아관 파천',
  '조청 상민 수륙 무역 장정': '조청상민수륙무역장정',
  '1910년대 무단통치': '1910년대',
  '치안 유지법': '치안유지법',
  '일제 무단통치': '1910년대',
  '일제 민족 말살 통치': '민족말살통치기',
  ...
  '미군정': '미군정',
  '반민특위': '반민특위',
  '5·18 민주화운동': '5·18 광주 민주화 운동',
  '교육입국조서': '교육입국조서',
  '한국 민주당': '한국민주당',
  '조선건국준비위원회': '건국 준비 위원회',
  '한미상호방위조약': '한미 상호 방위 조약',
  '경부고속도로': '경부 고속 도로',
  '개성공단': '개성공단',
  '진보당 사건': '진보당 사건',
  '기유각서': '기유각서',
